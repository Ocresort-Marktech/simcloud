...
class ControladorVentas
{
	...
	static public function ctrCrearVentas()
	{
		...
		if (isset($_POST["nuevoCliente"])) {
			...
			$correo = ModeloVentas::mdlCrearCorreo($destinatario);
	...
	public static function ctrSumaTotalVentas($item, $valor)
	{
	...
	static public function ctrSumaTotalVentasHoy($item, $valor)
	{
	...
	static public  function ctrMostrarVentasHoy($item, $valor, $item1, $valor1)
	{
	...
	static public function ctrSumaTotalVentasMes($item, $valor)
	{
