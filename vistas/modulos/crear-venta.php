    ...
    <div class="col-lg-8">
         <div class="ibox ">     
                ...
                <?php
                        ...
                        ' <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input list="browsers" name="nuevoSimcards" class="form-control mirarSimscards mirarVendida traerDestinos" id="nuevoSimcards652">
                            </div> 
                        </div> 
                        ...
                        ?>
                        <input type="hidden" class="form-control traerSimcard55" name="nuevoAgrego" value="<?php echo $_SESSION["idcoordinadordeadmin"] ?>"> 
                        <script type="text/javascript">
                            function cambiarPlanNuevo() {
                if (document.getElementById('destinosCargados').value === "Mexico") {
                document.getElementById('campo_otro').style.display = 'block';
                ...
                <div class="form-group" id="campo_otro1" style="display: none">
                        ...
                        <input type="hidden" class="form-control traerSimcard2" id="nuevoSimcardsDestino2" name="nuevoAgrego" value="<?php echo $_SESSION["id"] ?>"> 
                        <script type="text/javascript">
                            function cambiarPlanNuevo() {
                if (document.getElementById('destinosCargados').value === "Mexico") {
                document.getElementById('campo_otro').style.display = 'block';
                ...
                <div class="form-group" id="campo_otro1" style="display: none">
                      ...
                      <script type="text/javascript">
                              ...
                              $(document).ready(function(){
                                $('#nuevoSimcards652').val();
                                  recargarNumeroSimcardscoordinadoradmin();
                            
                                $('#nuevoSimcards652').change(function(){
                                  recargarNumeroSimcardscoordinadoradmin();
                                });
                              })
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9"> 
                                <div class="input-group date">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="date" class="form-control" name="nuevoFechaLlegada" min="<?php echo date("Y-m-d");?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group date">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="date" class="form-control" min="<?php echo date("Y-m-d");?>" name="nuevoFechaRegreso" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
