                         ...
                         echo'
                           ...
                           if ($_SESSION["perfil"] == "Administrador" || $_SESSION["perfil"] == "Coordinador") {
                               ...
                               echo '<button class="btn btn-success btn-xs btnActivarSimcard" estadoSimcard="desactivado" idSimcard="'.$value["id"].'" >Activado</button>';
                                ...
                                echo '<button class="btn btn-danger btn-xs btnActivarSimcard" estadoSimcard="activado" idSimcard="'.$value["id"].'" cliente="'.$value["cliente"].'"  linea="'.$value["lineaexterior"].'" destino="'.$value["destino"].'" fechallegada="'.$value["fechallegada"].'" valor="'.$value["valor"].'" correo="'.$value["email"].'">Desactivado</button>';
                            }
                           }else{
                             if ($value["estado"] != "desactivado") {
